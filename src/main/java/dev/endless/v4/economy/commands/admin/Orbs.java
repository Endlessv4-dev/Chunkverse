...
public class Orbs implements TabExecutor {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String string, @NotNull String @NotNull [] args) {
        ...
        if (cmd.equals("give")) {
            ...
            if (!player.hasPermission("chunkverse.orbs.give")) {
            ...
            if (!player.hasPermission("chunkverse.orbs.take")) {
                player.sendMessage("§c§lFAILED | §7You don't have permission to do this.");
                return false;
            }
            ...
            if (!player.hasPermission("chunkverse.orbs.set")) {
                player.sendMessage("§c§lFAILED | §7You don't have permission to do this.");
                return false;
            }
            ...
            player.sendMessage("§a§lSUCCESS | §7You have set 'orbs' for §e" + target.getName() + " §7to §6" + amount + "§7.");

        }
        else if (cmd.equals("reset")) {

            if (!player.hasPermission("chunkverse.orbs.reset")) {
                player.sendMessage("§c§lFAILED | §7You don't have permission to do this.");
                return false;
            }
            ...
            player.sendMessage("§a§lSUCCESS | §7You have reset §e" + target.getName() + "§7's orbs.");
    ...
    public @Nullable List<String> onTabComplete(@NotNull CommandSender sender, @NotNull Command command, @NotNull String alias, @NotNull String @NotNull [] args) {
        ...
        if (args.length == 2) {
            if (sender.hasPermission("chunkverse.orbs.give") && sender.hasPermission("chunkverse.orbs.take") &&
                sender.hasPermission("chunkverse.orbs.set") && sender.hasPermission("chunkverse.orbs.reset")) {
